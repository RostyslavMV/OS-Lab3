...
public class Scheduling {
    ...
    private static int meanDev = 100;
        ...
        try {
            ...
            while ((line = in.readLine()) != null) {
                ...
                if (line.startsWith("process")) {
                    ...
                    processVector.addElement(new sProcess(processVector.size(), userId, cputime, ioblocking, 0, 0, 0));
                }
    ...
    private static void debug() {
        ...
        for (i = 0; i < size; i++) {
            ...
            System.out.println("process " + i + " " + "userId " + process.userId + " " + process.cputime + " " + process.ioblocking + " " + process.cpudone + " " + process.numblocked);
        }
    ...
    private static void setMaxTimeForUser() {
        ...
        X = X * standardDev;
        maxTimeForUser = 2 * ((int) X + meanDev);
        return;
    }
    ...
    public static void main(String[] args) {
        ...
        if (processVector.size() < processnum) {
            ...
            while (processVector.size() < processnum) {
                ...
                processVector.addElement(new sProcess(processVector.size(), userid, cputime, i * 100, 0, 0, 0));
                i++;
            }
        }
        // setMaxTimeForUser();
        ...
        try {
            ...
            out.println("Process #\tUser Id\tCPU Time\tIO Blocking\tCPU Completed\tCPU Blocked");
